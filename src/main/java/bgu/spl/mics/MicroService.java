...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback> messageCall = new ConcurrentHashMap<>();
    ...
    public final void run() {
        ...
        while (!terminated) {
            ...
            try {
                newMessage = messageBus.awaitMessage(this);
            } catch (Exception e) {
                e.printStackTrace();
            }
            Callback newCall = messageCall.get(newMessage.getClass());
            newCall.call(newMessage);
        }
